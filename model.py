...
model.fit(X_train, y_train, validation_split=0.2, shuffle=True, nb_epoch=3, callbacks=[early_stop]) # fit the model and split the data to 20% validation and 80% training
